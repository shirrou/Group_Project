...
<html lang="en-US">
	<head>
		...
		<title>Payment Denied | PhoneBits</title>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="main-content">
								<div class="commerce">
									<p class="cart-empty"> <span style="color:#9B0000"><strong>Payment Denied!</strong> There was a problem in proccesing your payment.</span> <br>You have not been charged!</p>
									<p class="return-to-shop"><a class="button wc-forward rounded" href="cart.php">Return To Basket</a></p>
									<p class="return-to-shop"><a class="button wc-backward rounded" href="index.php">Return To Shop</a></p>
