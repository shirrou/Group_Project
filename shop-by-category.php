...
//query to get the item in the basket
...
$statement7= $db->prepare($queryBasketItem);
$statement7->execute();
$basket = $statement7->fetchAll();
$statement7->closeCursor();
//get total per ID USER
$queryTotBasket = 'SELECT SUM(itemBasketQTY*itemBasketPrice) AS total
FROM basket
WHERE userID = 1;';
$statement8= $db->prepare($queryTotBasket);
$statement8->execute();
$totalBasket = $statement8->fetch();
